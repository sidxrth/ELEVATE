import { Instagram, Facebook, CreditCard, Shield, Truck, Lock } from "lucide-react";
...
const socialLinks = [
  ...
  { name: "Pinterest", icon: CreditCard, href: "https://pinterest.com" },
  { name: "Facebook", icon: Facebook, href: "https://facebook.com" },
  { name: "TikTok", icon: Shield, href: "https://tiktok.com" },
];
    ...
    <section className="bg-background py-12 sm:py-16 md:py-24">
      <div className="container mx-auto max-w-6xl px-5 md:px-6">
        ...
        <div className="mb-10 flex flex-col items-start justify-between gap-10 border-b pb-10 sm:mb-16 sm:pb-12 md:flex-row">
          <div className="w-full max-w-full sm:max-w-sm">
            <a href="/" className="inline-block">
              <div className="mb-6 text-2xl font-bold tracking-tight text-foreground">
                STYLE
              </div>
            </a>
            <p className="mb-8 text-base text-muted-foreground">
              Stay connected for style updates and exclusive offers
            </p>
        ...
        <div className="mb-8 border-b pb-8">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-col gap-4">
              <h3 className="text-sm font-medium text-muted-foreground">We Accept</h3>
              <div className="flex items-center gap-4">
                {paymentMethods.map((method) => (
                  <div
                    key={method.name}
                    className="flex h-8 w-12 items-center justify-center rounded border bg-muted"
                  >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                <Truck className="h-5 w-5 text-brand-success" />
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <div className="order-2 flex flex-col gap-2 text-center sm:text-left md:order-1">
