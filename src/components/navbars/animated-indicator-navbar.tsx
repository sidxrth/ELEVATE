    ...
    <section className="py-4 bg-background border-b border-border">
      <nav className="container mx-auto flex items-center justify-between">
        ...
        <a href={NAV_LOGO.url} className="flex items-center gap-2">
          <span className="text-xl font-[var(--font-display)] font-bold tracking-tight text-foreground">
            {NAV_LOGO.title}
          </span>
        </a>
        ...
        <NavigationMenu className="hidden lg:block">
          <NavigationMenuList
            ref={menuRef}
            className="rounded-4xl flex items-center gap-8 px-8 py-3"
          >
            {NAV_ITEMS.map((item) => (
            ...
            >
              <div className="bg-accent h-0.5 w-full rounded-t-none transition-all duration-300" />
            </div>
          </NavigationMenuList>
        </NavigationMenu>
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <Button
            variant="ghost"
            size="sm"
            className="h-10 py-2.5 text-sm font-normal text-muted-foreground hover:text-foreground"
          >
